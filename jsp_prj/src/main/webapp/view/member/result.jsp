...
<div class="container border border-primary rounded-4 border-opacity-25" style="margin-top: 30px; padding: 30px;" >
	...
	${sessionScope.id }님 즐거운 하루 보내시길 바랍니다.
	<br><br>
	
	<a href="${pageContext.request.contextPath }/SearchController" style="text-decoration: none;">
	...
	<a href="${pageContext.request.contextPath }/LogoutController" style="text-decoration: none;">
	...
	<a href="${pageContext.request.contextPath }/DelController" style="text-decoration: none;">
	...
	<a href="${pageContext.request.contextPath }/seller/List" style="text-decoration: none;">
